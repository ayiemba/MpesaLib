...
namespace MpesaLib
{
    ...
    public class BusinessToBusinessDto
    {
        ...
        /// that it contains the port, URI and domain name or publicly available IP.
        /// </param>
        public BusinessToBusinessDto(string intiator, string securityCredential, string commandId, string amount, string partyA, string partyB, string senderIdentifierType, string receiverIdentifierType, string accountReference, string remarks, string queueTimeoutUrl, string resultUrl)
        {
            Initiator = intiator;
