...
namespace MpesaLib
{
    ...
    public class BusinessToCustomerDto
    {
        ...
        /// processing of the payment request.
        /// </param>
        public BusinessToCustomerDto(string intiatorName, string securityCredential, string commandId, string amount, string partyA, string partyB, string remarks, string occasion, string queueTimeoutUrl, string resultUrl)
        {
